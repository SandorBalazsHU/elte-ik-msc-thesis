...
\subsubsection{DenseNet121 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/DenseNet121_basic_conf_mat.png}
...
\subsubsection{DenseNet121 tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/DenseNet121_normalised_conf_mat.png}
