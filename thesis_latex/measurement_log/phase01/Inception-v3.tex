...
\subsubsection{Inception-v3 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/Inception-v3_basic_conf_mat.png}
...
\subsubsection{Inception-v3 tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/Inception-v3_normalised_conf_mat.png}
