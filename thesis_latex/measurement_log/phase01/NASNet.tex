...
\subsubsection{NASNet tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/NASNet_basic_conf_mat.png}
    \caption{NASNet tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{NASNet tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/NASNet_normalised_conf_mat.png}
    \caption{NASNet tanítás nélküli normalizált Confusion Mátrix}
    \label{fig:phase01_NASNet_normalised_conf_mat}
  \end{figure}

\subsubsection{NASNet tanítás nélküli részletes osztályonkénti metrikák}
