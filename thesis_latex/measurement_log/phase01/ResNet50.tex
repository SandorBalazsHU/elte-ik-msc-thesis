...
\subsubsection{ResNet50 tanítás nélkül teszt}
  \begin{center}
  \begin{longtable}{l c}
  ...
  \end{longtable}
  \end{center}
\subsubsection{ResNet50 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/phase01/ResNet50_basic_conf_mat.png}
    \caption{ResNet50 tanítás nélküli sima Confusion Mátrix}
