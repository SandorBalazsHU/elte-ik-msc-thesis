\chapter{Szoftveres környezet}
  ...
  \subsection{Az alkalmazott szoftveres környezet}
    ...
    \section{Google Colab lehetőségek}
        A Google Colab Pro (és Pro+) környezet többféle GPU-típushoz biztosít hozzáférést, köztük olyan erős architektúrákhoz, mint az NVIDIA A100 és L4. Ezek a kártyák a modern neurális hálózati modellekhez tervezett csúcshardverek, és kiválóan alkalmasak mélytanulási feladatokra.
    ...
    \section{Tárolási problémák}
        ...
        \end{itemize}
        A megközelítés nemcsak hatékony, de rugalmas is volt: a ZIP-fájlokat könnyen lehetett újracsoportosítani a különböző tanítókészletekhez (1k, 5k, 10k, 25k stb.), és a Colab környezet indítása után percek alatt elérhetővé vált a szükséges adathalmaz-részlet.
