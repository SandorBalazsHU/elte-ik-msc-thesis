...
\subsubsection{Inception-v3 tanítás nélkül teszt}
  ...
  \end{longtable}
  \end{center}
\subsubsection{Inception-v3 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/phase01/Inception-v3_basic_conf_mat.png}
    \caption{Inception-v3 tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{Inception-v3 tanítás nélküli normalizált Confusion Mátrix}
  ...
  \end{figure}
\subsubsection{Inception-v3 tanítás nélküli részletes osztályonkénti metrikák}
