\chapter{II. Fázis: Teljes tanítás}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/DenseNet121_learning_curve.png}
  ...
  \subsubsection{DenseNet121 eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/DenseNet121_compare01.png}
  ...
  \subsubsection{DenseNet121 eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/DenseNet121_compare02.png}
      \caption{DenseNet121 eredményeinek összehasonlítása}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/EfficientNet-B0_learning_curve.png}
  ...
  \subsubsection{EfficientNet-B0 eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/EfficientNet-B0_compare01.png}
  ...
  \subsubsection{EfficientNet-B0 eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/EfficientNet-B0_compare02.png}
      \caption{EfficientNet-B0 eredményeinek összehasonlítása}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/ConvNeXt-Tiny_learning_curve.png}
  ...
  \subsubsection{ConvNeXt-Tiny eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/ConvNeXt-Tiny_compare01.png}
  ...
  \subsubsection{ConvNeXt-Tiny eredményeinek összehasonlítása}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{images/phase02/ConvNeXt-Tiny_compare02.png}
      \caption{ConvNeXt-Tiny eredményeinek összehasonlítása}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/ViT-B-16_learning_curve.png}
...
\subsubsection{ViT-B-16 eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/ViT-B-16_compare01.png}
...
\subsubsection{ViT-B-16 eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/ViT-B-16_compare02.png}
    \caption{ViT-B-16 eredményeinek összehasonlítása}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/Inception-v3_learning_curve.png}
...
\subsubsection{Inception-v3 eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/Inception-v3_compare01.png}
...
\subsubsection{Inception-v3 eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/Inception-v3_compare02.png}
    \caption{Inception-v3 eredményeinek összehasonlítása}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/NASNet_learning_curve.png}
...
\subsubsection{NASNet eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/NASNet_compare01.png}
...
\subsubsection{NASNet eredményeinek összehasonlítása}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/phase02/NASNet_compare02.png}
    \caption{NASNet eredményeinek összehasonlítása}
...
\subsubsection{Összefoglaló táblázat a második fázis mért értékeiről.}
    \begin{center}
...
\subsubsection{Top 1 pontosságok összehasonlítása teljes tanítás után.}
    \begin{figure}[H]
        \centering
...
\subsubsection{F1 értékek összehasonlítása teljes tanítás után.}
    \begin{figure}[H]
        \centering
...
\subsubsection{Futási idők összehasonlítása teljes tanítás után a teszt halmazon.}
    \begin{figure}[H]
        \centering
...
\subsubsection{Top 1 és Top 5 pontosságok összehasonlítása teljes tanítás után a teszt halmazon.}
    \begin{figure}[H]
        \centering
...
\subsubsection{Precision, Recall és F1 összehasonlítása teljes tanítás után a teszt halmazon.}
    \begin{figure}[H]
        \centering
...
\subsubsection{Összehasonlító táblázat az első és a második fázis mért értékeiről.}
    \begin{center}
    ...
    \subsubsection{Top 1 és Top 5 pontosság összehasonlítása Pretrained és a Finetuned mérések között.}
    \begin{figure}[H]
        \centering
...
\subsubsection{Precision és Recall összehasonlítása Pretrained és a Finetuned mérések között.}
    \begin{figure}[H]
        \centering
...
\subsubsection{F1 score összehasonlítása Pretrained és a Finetuned mérések között.}
    \begin{figure}[H]
        \centering
...
\subsubsection{A Pretrained és a Fine-tuned modellek értékelése}
...
\subsubsection{Tanítási ciklusok elemzése}
...
\subsubsection{A Train és Validation loss alakulása modellenként.}
    \begin{figure}[H]
        \centering
...
\subsubsection{A Train és Validation accuracy alakulása modellenként.}
    \begin{figure}[H]
        \centering
...
\subsubsection{A Train és Validation loss alakulása modellenként epoch-ok szerint.}
    \begin{figure}[H]
        \centering
...
\subsubsection{A Train és Validation accuracy alakulása modellenként epoch-ok szerint.}
    \begin{figure}[H]
        \centering
...
\subsubsection{A második fázis rövid szöveges értékelése}
