...
if __name__ == "__main__":
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
            ...
            \label{fig:stage}
        \end{subfigure}
        \caption{Két kép egymás mellett}
        \label{fig:2_side_by_side}
    \end{figure}
    
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{images/db/places/orchestra_pit.png}
        \caption{Minta a \texttt{Places365} \textit{airfield} osztályából.}
        \label{fig:places365-airfield}
    \end{figure}

    % Következő 4 kép: 2x2 mátrixban
    \begin{figure}[H]
        \centering
        \begin{subfigure}[b]{0.45\textwidth}
            \centering
        ...
        \vspace{0.5cm} % Kis függőleges térköz a sorok között
