...
if __name__ == "__main__":
    ...
    %Rövid értelmezés a vett mintákról.
    ...
    \section{Statisztikák}
        ...
        \subsubsection{SBphotoThemes180K - Places365 osztályozása}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\textwidth]{images/db/stat/db_stat_places_01.png}
            \caption{SBphotoThemes180K - Places365 osztályozása}
        ...
        \begin{figure}[H]
            ...
            \caption{SBphotoThemes180K - Places365 eloszlása}
            \label{fig:places365-eloszlas}
        \end{figure}

        \subsubsection{SBphotoThemes180K - ImageNet1k osztályozása}
        \begin{figure}[H]
            \centering
            \includegraphics[width=1.0\textwidth]{images/db/stat/db_stat_imagenet_01.png}
            \caption{SBphotoThemes180K - ImageNet1k osztályozása}
        ...
        \begin{figure}[H]
            ...
            \caption{SBphotoThemes180K - ImageNet1k eloszlása}
        ...
        \begin{figure}[H]
            ...
            \caption{SBphotoThemes180K - ImageNet1k eloszlása halmazonként.}
            \label{fig:imagenet-gondola}
        \end{figure}
