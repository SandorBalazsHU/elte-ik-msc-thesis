...
\subsubsection{EfficientNet-B0 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/EfficientNet-B0_basic_conf_mat.png}
...
\subsubsection{EfficientNet-B0 tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/EfficientNet-B0_normalised_conf_mat.png}
