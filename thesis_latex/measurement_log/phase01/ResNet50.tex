...
\subsubsection{ResNet50 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ResNet50_basic_conf_mat.png}
...
\subsubsection{ResNet50 tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ResNet50_normalised_conf_mat.png}
