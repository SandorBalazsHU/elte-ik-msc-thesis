...
\subsubsection{DenseNet121 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/phase01/DenseNet121_basic_conf_mat.png}
    \caption{DenseNet121 tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{DenseNet121 tanítás nélküli részletes osztályonkénti metrikák}
