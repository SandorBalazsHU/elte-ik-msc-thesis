...
\subsubsection{EfficientNet-B0 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/phase01/EfficientNet-B0_basic_conf_mat.png}
    \caption{EfficientNet-B0 tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{EfficientNet-B0 tanítás nélküli részletes osztályonkénti metrikák}
