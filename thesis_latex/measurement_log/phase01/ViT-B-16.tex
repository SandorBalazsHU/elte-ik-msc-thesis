...
\subsubsection{ViT-B-16 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ViT-B-16_basic_conf_mat.png}
...
\subsubsection{ViT-B-16 tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ViT-B-16_normalised_conf_mat.png}
