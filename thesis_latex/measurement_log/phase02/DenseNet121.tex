...
\subsubsection{DenseNet121 eredményeinek összehasonlítása}
  ...
  Inference time & 25.15 & 25.23 sec \\
  \bottomrule
  \end{longtable}
  \end{center}
...
\subsubsection{DenseNet121 teljes tanítás utáni sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase02/DenseNet121_basic_conf_mat.png}
    \caption{DenseNet121 teljes tanítás utáni sima Confusion Mátrix}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase02/DenseNet121_basic_conf_mat_compare.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase02/DenseNet121_normalised_conf_mat.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase02/DenseNet121_normalised_conf_mat_compare.png}
...
\subsubsection{DenseNet121 teljes tanítás utáni részletes osztályonkénti metrikák}
  \input{tables/phase2_DenseNet121_class_table}
