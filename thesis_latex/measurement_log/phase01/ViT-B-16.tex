...
\subsubsection{ViT-B-16 tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/phase01/ViT-B-16_basic_conf_mat.png}
    \caption{ViT-B-16 tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{ViT-B-16 tanítás nélküli részletes osztályonkénti metrikák}
