\chapter{Bevezető}
    ...
    \section{Motiváció}
        ...
        \begin{itemize}
            ...
            \item \textbf{sbphotothemes180k.zip} (9,48 GB) – Az eredeti, rendezés nélküli, de már feldolgozott egyedi képeket tartalmazó adathalmaz, amely az SBphotothemes180k névre hallgató adatbázis alapját képezi.
    ...
    \section{Mellékletek}
        ...
        \subsection{Melléklet B: Az elkészített szoftverek}
    ...
    \section{A feladat}
        ...
        \subsection{Képosztályozás mint feladat}
            ...
            \begin{flushright}
                \small
                Források: \cite{article_cnn_image_class} \cite{article_Photo_Content_Classification} \cite{article_cnn_metrics}
            \end{flushright}
        ...
        \subsection{A konvolúciós neurális hálózatok mint megoldás}
            ...
            \begin{flushright}
                \small
                Források: \cite{article_cnn_survey} \cite{article_cnn_metrics} \cite{article_cnn_image_class}
            \end{flushright}
        ...
        \subsection{Képadatbázisok mint tanító eszközök}
            ...
            \begin{flushright}
                \small
                Források: \cite{article_cnn_metrics} \cite{article_cnn_survey}  \cite{ardicle_dl_survey} 
            \end{flushright}
