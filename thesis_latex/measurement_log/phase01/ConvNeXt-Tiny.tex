...
\subsubsection{ConvNeXt-Tiny tanítás nélkül sima Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ConvNeXt-Tiny_basic_conf_mat.png}
    \caption{ConvNeXt-Tiny tanítás nélküli sima Confusion Mátrix}
...
\subsubsection{ConvNeXt-Tiny tanítás nélküli normalizált Confusion Mátrix}
  \begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{images/phase01/ConvNeXt-Tiny_normalised_conf_mat.png}
    \caption{ConvNeXt-Tiny tanítás nélküli normalizált Confusion Mátrix}
    \label{fig:phase01_ConvNeXt-Tiny_normalised_conf_mat}
  \end{figure}

\subsubsection{ConvNeXt-Tiny tanítás nélküli részletes osztályonkénti metrikák}
